...
// ✅ FIXED: Removed all duplicate CSS properties causing Vite warnings
...
const IntroModal = ({ isOpen, onClose, onComplete }) => {
 ...
 document.body.style.height = '100dvh'; // Use only the modern property
 } else {
...
>
 ...
 {isOpen && (
 <>
 {/* ✅ FIXED: Full-screen backdrop with no duplicate properties */}
 <motion.div 
 className="fixed mx-auto inset-0 bg-black/50 backdrop-blur-sm z-[10000]"
 style={{
 // ✅ Only use modern viewport properties - no duplicates
 top: 0,
 left: 0,
 right: 0,
 bottom: 0,
...
>
 {/* ✅ FIXED: Modal container with no duplicate properties */}
 <div 
