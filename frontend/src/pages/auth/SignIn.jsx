      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-white/90 text-lg drop-shadow-md">
            Sign in to continue browsing amazing spaces
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white/20 backdrop-blur-md border border-white/30 text-center p-3 rounded-2xl shadow-2xl">
            ...
            <p className="text-xs font-medium text-white drop-shadow-md">Secure Login</p>
          </div>
          <div className="bg-white/20 backdrop-blur-md border border-white/30 text-center p-3 rounded-2xl shadow-2xl">
            <Zap className="w-5 h-5 text-blue-400 mx-auto mb-1 drop-shadow-lg" />
            <p className="text-xs font-medium text-white drop-shadow-md">Quick Access</p>
          </div>
          <div className="bg-white/20 backdrop-blur-md border border-white/30 text-center p-3 rounded-2xl shadow-2xl">
            <Sparkles className="w-5 h-5 text-purple-400 mx-auto mb-1 drop-shadow-lg" />
            <p className="text-xs font-medium text-white drop-shadow-md">Premium Tools</p>
          </div>
        </div>
        
        {/* Sign-In Form Card - Enhanced Glassmorphism */}
