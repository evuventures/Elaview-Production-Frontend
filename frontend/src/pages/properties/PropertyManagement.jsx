...
>
 ...
 <Button variant="destructive" size={20} onClick={handleDeleteProperty} className="rounded-2xl">
 ...
 <Button onClick={handleToggleListing} size={32} className="w-full bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-hover))] text-white rounded-2xl shadow-[var(--shadow-brand)] hover:shadow-[var(--shadow-brand-lg)] transition-brand">
 ...
 <Button variant="outline" size={20} className="flex-1 border-[hsl(var(--border))] hover:bg-[hsl(var(--muted))] rounded-xl" onClick={() => handleEditArea(area)}>
...
>
 ...
 <Button variant="destructive" size={20} className="flex-1 rounded-xl" onClick={() => handleDeleteArea(area.id)}>
